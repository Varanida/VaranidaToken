...
contract Varanida is Ico, MintableToken, Vesting {
  ...
  uint256 private constant RESERVE_DISTRIBUTION_DURATION = 4 * 365 days;
  ...
  uint256 private constant FOUNDERS_CLIFF = 365 days;
  uint256 private constant FOUNDERS_DURATION = 365 days;
